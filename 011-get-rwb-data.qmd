...
As this inconsistencies cover the years 2022-2025 but also 2013-2021 **I have to clean up these inconsistencies later when I put together these two batches of datasets.**
::::
:::::
...
#| lst-label: lst-011-cleam-values-2022-2025
#| lst-cap: "Follow the procedure of @prp-011-clean-values and clean values for the RWB datasets 2022-2025"
#| eval: false
...
4. Another issue is the missing of the `Score evolution` column. This column is important and easy to compute because `Score N` and `Score N-1` are present. But this change has to be done after cleaning the `Score N` and `Score N-1` values.

::: {.callout-important #imp-011-column-sequencefor-row-binding}
###### The column sequence for row binding is irrelevant. Importantis the match of column names. 
:::
...
#| lst-label: lst-011-cleam-values-2013-2021
#| lst-cap: "Follow the procedure of @prp-011-clean-values and clean values for the RWB datasets 2013-2021"
#| eval: false
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-011-clean-columns-2002-2013}
: Clean column structure 2002-2013
::::::
:::
::::{.my-r-code-container}
...
<center>**Run this code chunk manually if the recoded file(s) still needs to be created**</center>
```{r}
#| label: clean-columns-2002-2013
#| lst-label: lst-011-clean-columns-2002-2013
#| lst-cap: "Clean / reorganize column structure for row binding"
#| eval: false
...
get_rsf_recoded2(2002:2013, load_path)
...
```{r}
#| label: clean-values-2002-2013
#| lst-label: lst-011-cleam-values-2002-2013
#| lst-cap: "Follow the procedure of @prp-011-clean-values and clean values for the RWB datasets 2013-2021"
#| eval: false
...
rwb_rec3 <- function(df) {
    for (i in seq_along(df)) {
        if (is.character(df$year_n)) {
            df <- dplyr::mutate(df, year_n = as.numeric(2012))
        }
...
df_list3 = list(rsf2013_rec3, rsf2012_rec3, rsf2010_rec3, rsf2009_rec3,
                rsf2008_rec3, rsf2007_rec3, rsf2006_rec3, rsf2005_rec3,
                rsf2004_rec3, rsf2003_rec3, rsf2002_rec3)
lapply(df_list3, rwb_rec3)

########## bind rows
rwb3 <- dplyr::bind_rows(rwb2013, `rwb2012`, rwb2010, rwb2009, rwb2008,
                         rwb2007, rwb2006, rwb2005, rwb2004, rwb2003, rwb2002) |>
    dplyr::mutate(dplyr::across(dplyr::where(is.character), as.factor)) |>
    dplyr::arrange(desc(year_n), country_en)
