...
I have finished approximately 10%. This is just a rough guess, derived from my @sec-project-plan.
...
I take as a model for my practical project the [Word Happiness Report](https://data.worldhappiness.report/map) (`r glossary("WHR")`) dashboard. I cannot plan the details here but my dashboard (see for the current state of the project plan chapter @sec-chap059) should contain the following main visualizations:
