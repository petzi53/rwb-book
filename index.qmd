...
I will apply the intermediate results of my code development parallel the [Shiny package RSF](https://github.com/petzi53/rsf) (Reporters sans frontières). After some research I learned that the {**bslib**} package is the most modern package fpr dashboard development. I looked into
