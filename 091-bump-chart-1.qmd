...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-062-number-of-countries-per-year}
: Number of countries evaluated per year for the World Press Freedom Index (WPFI)
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: tbl-062-number-of-countries-per-year
...
::: {.callout-important #imp-062-bump-charts-and-plotly}
...
my_save_data_file("chap062", vec_top_ten_2025, "vec_top_ten_2025.rds")
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-062-most-basic-bump-chart}
: Evolution of the rankings of the top ten countries in 2025
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-062-most-basic-bump-chart
