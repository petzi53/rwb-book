...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-093-bump-chart-text-labels}
: Evolution of the rankings of the top ten countries in 2025
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-093-bump-chart-text-labels
...
:::::{.my-resource}
:::{.my-resource-header}
:::::: {#lem-093-second-axis-with-plotly}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-093-bump-chart-second-axis}
: Evolution of the rankings of top eight countries
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-093-bump-chart-second-axis
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-093-adding-flags}
: Adding Flags with {**ggplot2**}
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: tbl-093-adding-flags
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-093-bump-chart-show-flags}
: Evolution of the rankings of top eight countries
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-093-bump-chart-show-flags
#| fig-cap: "Evolution of the rankings of top eight countries"
#| fig.height: 9
#| eval: false
...
## file: app.R
{{< include app-093-bump-chart/app.R >}}
