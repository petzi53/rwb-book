...
1. **Functionalities** (@sec-059-functionalities): I am presenting in this section the concept and status of realization for my dashboard on Reporters Without Borders (`r glossary("RWB")`).
