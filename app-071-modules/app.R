## path: app-071-modules/app.R
## MS book: chapter 19: Shiny modules
## my book: ????
## description: use modules to reduce complexity
...
chartUI <-  function(id) {
    htmltools::tagList(
        card(
            card_header((textOutput(NS(id, "card_title")))),
            plotlyOutput(NS(id, "p"))
        )
    )
}
