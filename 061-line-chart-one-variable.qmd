# Line Chart: One variable {#sec-chap061}
...
The final figure with immediate drawing each selected countries includes some simplification and the solution to my colorscale problem (see @sec-061-solution-fixed-color).
...
### Solution fixed color {#sec-061-solution-fixed-color}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-061-line-chart-pws-solution}
...
## file: app.R
{{< include app-061-line-chart-pws-solution/app.R >}}
